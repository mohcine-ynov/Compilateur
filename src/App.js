...
function App() {
  ...
  const [languageList, setLanguageList] = useState([
    { id: 45, label: "Assembly (NASM 2.14.02)", exercices: [""], initCode: "" },
    { id: 46, label: "Bash (5.0.0)", exercices: [""], initCode: "" },
    { id: 47, label: "Basic (FBC 1.07.1)", exercices: [""], initCode: "" },
    { id: 75, label: "C (Clang 7.0.1)", exercices: [""], initCode: "" },
    { id: 76, label: "C++ (Clang 7.0.1)", exercices: [""], initCode: "" },
    { id: 48, label: "C (GCC 7.4.0)", exercices: [""], initCode: "" },
    {
      id: 52,
      label: "C++ (GCC 7.4.0)",
      exercices: [
...
\nint main(void) {
  // use printf to display your result
  return 0;
}`,
    },
    { id: 49, label: "C (GCC 8.3.0)", exercices: [""], initCode: "" },
    { id: 53, label: "C++ (GCC 8.3.0)", exercices: [""], initCode: "" },
    { id: 50, label: "C (GCC 9.2.0)", exercices: [""], initCode: "" },
    { id: 54, label: "C++ (GCC 9.2.0)", exercices: [""], initCode: "" },
    { id: 86, label: "Clojure (1.10.1)", exercices: [""], initCode: "" },
    { id: 51, label: "C# (Mono 6.6.0.161)", exercices: [""], initCode: "" },
    { id: 77, label: "COBOL (GnuCOBOL 2.2)", exercices: [""], initCode: "" },
    {
      id: 55,
    ...
    { id: 90, label: "Dart (2.19.2)", exercices: [""], initCode: "" },
    { id: 56, label: "D (DMD 2.089.1)", exercices: [""], initCode: "" },
    { id: 57, label: "Elixir (1.9.4)", exercices: [""], initCode: "" },
    { id: 58, label: "Erlang (OTP 22.2)", exercices: [""], initCode: "" },
    { id: 44, label: "Executable", exercices: [""], initCode: "" },
    {
      id: 87,
    ...
    { id: 60, label: "Go (1.13.5)", exercices: [""], initCode: "" },
    { id: 88, label: "Groovy (3.0.3)", exercices: [""], initCode: "" },
    { id: 61, label: "Haskell (GHC 8.8.1)", exercices: [""], initCode: "" },
    { id: 62, label: "Java (OpenJDK 13.0.1)", exercices: [""], initCode: "" },
    {
      id: 63,
      label: "JavaScript (Node.js 12.14.0)",
      exercices: [
    ...
    { id: 78, label: "Kotlin (1.3.70)", exercices: [""], initCode: "" },
    { id: 64, label: "Lua (5.3.5)", exercices: [""], initCode: "" },
    { id: 89, label: "Multi-file program", exercices: [""], initCode: "" },
    {
      id: 79,
    ...
    { id: 65, label: "OCaml (4.09.0)", exercices: [""], initCode: "" },
    { id: 66, label: "Octave (5.1.0)", exercices: [""], initCode: "" },
    { id: 67, label: "Pascal (FPC 3.0.4)", exercices: [""], initCode: "" },
    { id: 85, label: "Perl (5.28.1)", exercices: [""], initCode: "" },
    { id: 68, label: "PHP (7.4.1)", exercices: [""], initCode: "" },
    { id: 43, label: "Plain Text", exercices: [""], initCode: "" },
    {
      id: 69,
    ...
    { id: 70, label: "Python (2.7.17)", exercices: [""], initCode: "" },
    { id: 71, label: "Python (3.8.1)", exercices: [""], initCode: "" },
    { id: 80, label: "R (4.0.0)", exercices: [""], initCode: "" },
    { id: 72, label: "Ruby (2.7.0)", exercices: [""], initCode: "" },
    { id: 73, label: "Rust (1.40.0)", exercices: [""], initCode: "" },
    { id: 81, label: "Scala (2.13.2)", exercices: [""], initCode: "" },
    { id: 82, label: "SQL (SQLite 3.27.2)", exercices: [""], initCode: "" },
    { id: 83, label: "Swift (5.2.3)", exercices: [""], initCode: "" },
    { id: 74, label: "TypeScript (3.7.4)", exercices: [""], initCode: "" },
    {
      id: 84,
